...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GSOC研究生课题组_南邮', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '这个人很懒，只会干饭🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ddlhappy.xyz/', // 网站地址
